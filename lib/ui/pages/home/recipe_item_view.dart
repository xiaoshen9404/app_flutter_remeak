...
class RecipeItemView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => _jumpToDetail(context, _recipeRows?.smallVertical ?? ""),
      child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child:
                ...
                Hero(
                  tag: "Hero_${_recipeRows?.smallVertical ?? ""}",
                  child: ClipRRect(
            ...
            Container(
              ...
              child: Text(
                ...
                style:
                    TextStyle(color: const Color(0xff979797), fontSize: 14.sp),
              ),
            )
          ]),
    );
  ...
  void _jumpToDetail(BuildContext context, String imgUrl) {
    Navigator.of(context)
        .pushNamed(RecipeDetail.ROUTE_NAME, arguments: imgUrl)
        .then((value) {
      //RecipeDetail关闭后返回的result，类型对应上面的MaterialPageRoute<String>
      print(value);
    });
  }
}
